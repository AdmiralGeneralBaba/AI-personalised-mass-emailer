...
- An Education AI project in content creation that creates content for both teachers and student holistically in all areas of study/teacher resources with prototypes created for exam paper creation, lesson planning, homework creation, question creation, flashcard creation, MCQ creation, and powerpoint creation.
- More models are also in the works
- We achieved this in less than 2 months. 
- Uses the latest AI models, and dozens of high level models to achieve this.
- I am taking a gap year to work on this project
- Working prototype with GUI expected to be finished within 3 weeks (MVP)
        ...
        senderJson = """My JSON information (THIS IS INFORMATION ON THE SENDER OF THE EMAI):
{
  "profile": {
    ...
    "connections": 14,
    "summary": "As a dedicated Computer scientist, I've spent the past two years deeply studying a multitude of research papers. My goal has been to understand and master the capabilities of the latest AI models. More than a job, this has been a journey, allowing me to solidify my knowledge and recognize the importance of focus and deep learning.

Commitment to my field inspired me to take a sabbatical between my 2nd and penultimate year of university. This was a decision to invest in myself, to fully immerse in developing and integrating AI into new SaaS products. This is my strategic choice for long-term growth.

During this time, I am completely engaged in AI, constantly pushing myself to develop innovative solutions. This isn't just a break from academics.

This period also allows me to hone my AI skills and broaden my knowledge base. I aim to come out of this experience not only with a better understanding of AI but also as a changed individual, capable of steering the course of technology.

I am consistently amazed by the potential of AI and the endless possibilities it presents. I am convinced that the fusion of AI and SaaS will usher in a new era of technological progression. I am excited to be part of this transformation, ready to shape the future, and, if necessary, disrupt the status quo for the greater good.",
    "creator_mode": false,
    "profile_views": 14,
    "search_appearances": 3
  },
...
"""
    ...
    def ai_email_full_sending_and_creation(self, email_sendersList, email_passwordList, json_list, sender_name, num_of_emails_sent_per_email):
      ...
      for json_obj in json_list:
          ...
          sender_index = (email_count // num_of_emails_sent_per_email) % len(email_sendersList)
...
file_path = "C:\\Users\\david\\Desktop\\Linkedin\\Linkedin code\\AI-personalised-mass-emailer\\Code\\data\\linkedin_people_profile_2023-07-17T22-15-56.jsonl"
