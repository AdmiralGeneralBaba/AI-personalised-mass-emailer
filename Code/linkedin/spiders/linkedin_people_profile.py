...
class LinkedInPeopleProfileSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for profile in profile_tuples:    
            ...
            yield scrapy.Request(url=linkedin_people_url, callback=self.parse_profile, meta={'investorEmail': profile[0], 'profile': profile[1], 'linkedin_url': linkedin_people_url})

    def parse_profile(self, response):
        item = {}
        item['investorEmail'] = response.meta['investorEmail']
